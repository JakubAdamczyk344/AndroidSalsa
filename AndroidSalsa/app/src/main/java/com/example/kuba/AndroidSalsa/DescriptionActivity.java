...
public class DescriptionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //z plikiem activity_description przechowującym layout okna zawierającego informacje
        ...
        //powiązanie obiektów klasy pole tekstowe zdefiniowanym w tej klasie z polami tekstowymi
        // z layoutu activity_description
    ...
    // Metoda pobierająca argumenty day oraz hour (z bazy danych) zwracająca
    // wartość long (Ilość milisekund od roku 1970)
    private long getData(String day,String hour){
        ...
        // Ustawianie kalendarza za pomoca petli switch, argumetami funkcji calendar.set są:
        //rok,miesiąc,dzień,godzina,minuta

        switch(Integer.parseInt(Month)){

            case 1: {
                calendar.set(Integer.parseInt(Year),Calendar.JANUARY,
                        Integer.parseInt(Day),Integer.parseInt(Hour),Integer.parseInt(Min));
                break;
            }
            case 2: {
                calendar.set(Integer.parseInt(Year), Calendar.FEBRUARY,
                        Integer.parseInt(Day), Integer.parseInt(Hour), Integer.parseInt(Min));
                break;
            }
            case 3: {
                calendar.set(Integer.parseInt(Year), Calendar.MARCH,
                        Integer.parseInt(Day), Integer.parseInt(Hour), Integer.parseInt(Min));
                break;
            }
            case 4: {
                calendar.set(Integer.parseInt(Year), Calendar.APRIL,
                        Integer.parseInt(Day), Integer.parseInt(Hour), Integer.parseInt(Min));
                break;
            }
            case 5: {
                calendar.set(Integer.parseInt(Year), Calendar.MAY,
                        Integer.parseInt(Day), Integer.parseInt(Hour), Integer.parseInt(Min));
                break;
            }
            case 6: {
                calendar.set(Integer.parseInt(Year), Calendar.JUNE,
                        Integer.parseInt(Day), Integer.parseInt(Hour), Integer.parseInt(Min));
                break;
            }
            case 7: {
                calendar.set(Integer.parseInt(Year), Calendar.JULY,
                        Integer.parseInt(Day), Integer.parseInt(Hour), Integer.parseInt(Min));
                break;
            }
            case 8: {
                calendar.set(Integer.parseInt(Year), Calendar.AUGUST,
                        Integer.parseInt(Day), Integer.parseInt(Hour), Integer.parseInt(Min));
                break;
            }
            case 9: {
                calendar.set(Integer.parseInt(Year), Calendar.SEPTEMBER,
                        Integer.parseInt(Day), Integer.parseInt(Hour), Integer.parseInt(Min));
                break;
            }
            case 10: {
                calendar.set(Integer.parseInt(Year), Calendar.OCTOBER,
                        Integer.parseInt(Day), Integer.parseInt(Hour), Integer.parseInt(Min));
                break;
            }
            case 11: {
                calendar.set(Integer.parseInt(Year), Calendar.NOVEMBER,
                        Integer.parseInt(Day), Integer.parseInt(Hour), Integer.parseInt(Min));
                break;
            }
            case 12: {
                calendar.set(Integer.parseInt(Year), Calendar.DECEMBER,
                        Integer.parseInt(Day), Integer.parseInt(Hour), Integer.parseInt(Min));
                break;
            }
